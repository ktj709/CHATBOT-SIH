"""
FastAPI Application for GyaanSetu RAG Chatbot.
...
# Create FastAPI app
app = FastAPI(
    title="GyaanSetu Chatbot API",
    description="RAG-based chatbot for GyaanSetu education platform",
    version="1.0.0"
)
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Your AI guide to the GyaanSetu education platform (FastAPI)</p>
        </header>
...
async def health():
    ...
    return HealthResponse(status="healthy", service="GyaanSetu Chatbot")
...
if __name__ == "__main__":
    import uvicorn
    print(f"Starting GyaanSetu Chatbot (FastAPI) on port {PORT}")
